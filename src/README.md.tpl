...
<h4 align="center">I'm currently living in Ourense at <strong>%{{temperature}}%ºC</strong> 🌡️</h4>
...
<p align="center">
  ...
  <img alt="Github Actions" src="https://img.shields.io/badge/Github_Actions-2088FF?style=flat&logo=Github_Actions&logoColor=white" />  
</p>

---

- Special thanks to @midudev for his tutorial.
- Weather data powered by Aemet. (Updated each hour - Last update at %{{last_update}}%h).
